...
Java_com_example_songhui_myapplication_SavePicService_saveJpgInService(JNIEnv *env,
                                                                       jobject instance,
                                                                       jstring savePath_,
                                                                       jbyteArray jpg_,
                                                                       jint length) {
...
JNIEXPORT void JNICALL
Java_com_example_songhui_myapplication_MyCameraActivity_saveJpg(JNIEnv *env, jobject instance,
